        ...
        <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-10 items-center py-10 sm:py-16">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4" id="download">
              <a
                href="https://github.com/mattbeckstrand/Epiphany_download/releases/latest/download/Epiphany%20AI.dmg" 
              ...
              <a href="https://github.com/mattbeckstrand/Epiphany_download/releases/latest/download/Epiphany%20AI%20Setup%20x64.exe" className="inline-flex items-center justify-center gap-2 px-6 py-2.5 text-sm sm:text-base rounded-full border border-foreground/15 hover:border-foreground/30 transition-colors whitespace-nowrap">
